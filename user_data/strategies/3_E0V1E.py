...
class E0V1E(IStrategy):
    ...
    buy_cti_32 = DecimalParameter(-1, 1, default=-0.52, decimals=2, space='buy', optimize=True)


    # 新增可优化参数：24小时价格变化百分比范围
    buy_24h_min_pct1 = DecimalParameter(-30.0, 0.0, default=-25, decimals=1, space='buy', optimize=True)
    buy_24h_max_pct1 = DecimalParameter(0.0, 200.0, default=40, decimals=1, space='buy', optimize=True)
    
    buy_cti_2 = DecimalParameter(-1, 1, default=0.5, decimals=2, space='buy', optimize=True)


    # 新增可优化参数：24小时价格变化百分比范围
    buy_24h_min_pct2 = DecimalParameter(-30.0, 0.0, default=-15.4, decimals=1, space='buy', optimize=True)
    buy_24h_max_pct2 = DecimalParameter(0.0, 200.0, default=10.8, decimals=1, space='buy', optimize=True)
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        buy_2 = (
                ...
                (dataframe['24h_change_pct'] > self.buy_24h_min_pct2.value) &  # 使用可优化参数
